...
<script>
	export default {
		...
		onLoad() {
			let pre_reg_page=this.getConst().host+this.getConst().projectName+"pages/login/register";
		...
		methods: {
			...
			register(){
				...
				if(!!wxuser&&!!wxuser.wxAppOpenId){o.wxAppOpenId=wxuser.wxAppOpenId;}
				if(!!wxuser&&!!wxuser.wxMpOpenId){o.wxMpOpenId=wxuser.wxMpOpenId;}
