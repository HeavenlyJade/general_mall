	...
	<view class="user">
		...
		<view class="user-wrap" @click="tologin()">
			...
			<view class="info">
				...
				<image class="avatar" mode="aspectFill" :src="storeUser.wxHeadImg||userInfo.headImg||userInfo.wxHeadImg||getConst().defaultAvatar"></image>
				<view class="nickname">{{ storeUser.wxNickName||userInfo.wxNickName||userInfo.nickName }}
